...
def test_unleash_provider_all_methods_implemented():
    ...
    assert hasattr(provider, "resolve_boolean_details_async")
    assert hasattr(provider, "resolve_string_details_async")
    assert hasattr(provider, "resolve_integer_details_async")
    assert hasattr(provider, "resolve_float_details_async")
    assert hasattr(provider, "resolve_object_details_async")
